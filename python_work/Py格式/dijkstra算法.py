...
#float('inf')表示无穷
    graph=np.array([[0,50,30,40,25],
            [50,0,15,20,float('inf')],
            [30,15,0,10,20],
            [40,20,10,0,10],
            [25,float('inf'),20,10,0]])
    G=Graph(graph,labels=['v1','v2','v3','v4','v5','v6'])
    start=input('请从v1到v6中输入起始点（格式为vi）')
    endnode=input('请从v1到v6中输入终点（格式为v1）')
